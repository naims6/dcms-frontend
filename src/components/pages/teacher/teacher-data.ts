...
export const teachers: Teacher[] = [
  {
    ...
    levelBn: "সিনিয়র প্রশিক্ষক",
    email: "ayesha@dcms.edu.bd",
    phone: "+880 1711-000001",
    experience: 12,
    education: "M.Sc. in Mathematics, Dhaka University",
    educationBn: "এম.এস.সি. গণিত, ঢাকা বিশ্ববিদ্যালয়",
    bio: "Ayesha brings 12 years of classroom experience with a passion for making complex mathematical concepts accessible and engaging for all students.",
    bioBn:
      "আয়েশা ১২ বছরের শ্রেণিকক্ষ অভিজ্ঞতা নিয়ে জটিল গাণিতিক ধারণাগুলো সকল শিক্ষার্থীর কাছে সহজবোধ্য করে তোলেন।",
    image:
  ...
  },
  {
    ...
    department: "Science",
    departmentBn: "বিজ্ঞান",
    level: "Head of Science Department",
    levelBn: "বিজ্ঞান বিভাগের প্রধান",
    email: "rafiq@dcms.edu.bd",
  ...
  },
  {
    ...
    departmentBn: "ভাষা",
    level: "Language Specialist",
    levelBn: "ভাষা বিশেষজ্ঞ",
    email: "sadia@dcms.edu.bd",
    ...
    bio: "Sadia specializes in communicative English teaching, helping students build confidence in reading, writing, and spoken English.",
    bioBn:
      "সাদিয়া যোগাযোগমূলক ইংরেজি শিক্ষায় বিশেষজ্ঞ এবং শিক্ষার্থীদের পড়া, লেখা ও কথ্য ইংরেজিতে আত্মবিশ্বাস গড়ে তুলতে সাহায্য করেন।",
    image:
