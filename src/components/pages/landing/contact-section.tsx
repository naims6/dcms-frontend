      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-3">{t("infoTitle")}</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground">{t("addressTitle")}</h4>
                  <p className="text-muted-foreground leading-relaxed mt-1">{t("addressText")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground">{t("phoneTitle")}</h4>
                  <p className="text-muted-foreground leading-relaxed mt-1 font-medium">{t("phoneText")}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-foreground">{t("emailTitle")}</h4>
                  <p className="text-muted-foreground leading-relaxed mt-1 font-medium">{t("emailText")}</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-card border border-border shadow-md rounded-2xl p-6 sm:p-8 md:p-10 h-full flex flex-col">
            <form className="space-y-6 h-full flex flex-col" onSubmit={(e) => { e.preventDefault(); /* form logic */}}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="name" type="text" placeholder={t("formName")} className="h-12 bg-background border-border/50" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder={t("formEmail")} className="h-12 bg-background border-border/50" />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="subject" type="text" placeholder={t("formSubject")} className="h-12 bg-background border-border/50" />
              </div>
              ...
              <Button type="submit" size="lg" className="w-full h-12 text-base font-semibold group rounded-xl mt-auto">
                {t("formSubmit")}
