        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col space-y-4 group">
              ...
              <div className="pt-2">
                <h3 className="font-bold text-xl text-foreground mb-1">{t("card1Name")}</h3>
                <p className="text-sm font-medium text-muted-foreground mb-3">{t("card1Role")}</p>
                <button className="text-primary text-sm font-semibold hover:underline flex items-center gap-1 group/btn">
                  {t("card1Btn")} <ChevronRight className="h-3 w-3 transition-transform group-hover/btn:translate-x-1" />
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-4 group">
              ...
              <div className="pt-2">
                <h3 className="font-bold text-xl text-foreground mb-1">{t("card2Name")}</h3>
                <p className="text-sm font-medium text-muted-foreground mb-3">{t("card2Role")}</p>
                <button className="text-destructive text-sm font-semibold hover:underline flex items-center gap-1 group/btn">
                  {t("card2Btn")} <ChevronRight className="h-3 w-3 transition-transform group-hover/btn:translate-x-1" />
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-4 group">
              ...
              <div className="pt-2">
                <h3 className="font-bold text-xl text-foreground mb-1">{t("card3Name")}</h3>
                <p className="text-sm font-medium text-muted-foreground mb-3">{t("card3Role")}</p>
                <button className="text-destructive text-sm font-semibold hover:underline flex items-center gap-1 group/btn">
                  {t("card3Btn")} <ChevronRight className="h-3 w-3 transition-transform group-hover/btn:translate-x-1" />
                </button>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-4">
                  <div className="w-12 h-12 rounded-full border-2 border-background overflow-hidden relative">
                     <Image src="https://images.unsplash.com/photo-1560250097-0b93528c311a?w=100&q=80" alt="President" fill className="object-cover" />
                  </div>
                  <div className="w-12 h-12 rounded-full border-2 border-background overflow-hidden relative">
                     <Image src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&q=80" alt="Head" fill className="object-cover" />
                  </div>
                </div>
                <div>
                  <p className="font-medium text-foreground text-sm">Dedicated Leadership</p>
                  <p className="text-xs text-muted-foreground">Guiding since 2005</p>
                </div>
              </div>
            </div>
