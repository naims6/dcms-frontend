        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-2 flex flex-col gap-2 text-sm text-neutral-600 dark:text-neutral-400">
              <p><strong className="font-medium text-neutral-900 dark:text-neutral-200">{t("addressTitle")}</strong> {t("address")}</p>
              <p><strong className="font-medium text-neutral-900 dark:text-neutral-200">{t("phoneTitle")}</strong> {t("phone")}</p>
              <p><strong className="font-medium text-neutral-900 dark:text-neutral-200">{t("emailTitle")}</strong> {t("email")}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5">
              {["studentPortal", "noticeBoard", "events", "careers"].map((key) => (
                <li key={key}>
                  <Link 
                  ...
                  >
                    <span className="w-1 h-1 rounded-full bg-neutral-300 dark:bg-neutral-700 group-hover:bg-primary transition-colors" />
                    <span className="group-hover:translate-x-1 transition-transform duration-300">
                      {t(key as "studentPortal" | "noticeBoard" | "events" | "careers")}
                    </span>
                  </Link>
                </li>
              ))}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-4 flex items-center gap-3">
              <Button variant="outline" size="icon" className="rounded-full bg-transparent hover:bg-primary/10 hover:text-primary hover:border-primary/20 transition-all text-neutral-500">
